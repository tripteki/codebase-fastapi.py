...
class AppAuth:
    ...
    @classmethod
    def createAccessToken (cls, data: Dict[str, Any], expiresDelta: Optional[timedelta] = None) -> str:
        """
        Args:
            data (Dict[str, Any])
    ...
    @classmethod
    def createRefreshToken (cls, data: Dict[str, Any]) -> str:
        """
        Args:
            data (Dict[str, Any])
        Returns:
    ...
    @classmethod
    def verifyToken (cls, token: str, tokenType: str = "access") -> Optional[Dict[str, Any]]:
        """
        Args:
            token (str)
            tokenType (str)
    ...
    @classmethod
    def decodeToken (cls, token: str) -> Optional[Dict[str, Any]]:
        """
        Args:
            token (str)
        Returns:
