...
class TestUserAuth:
    ...
    @pytest.mark.asyncio
    async def test_auth_register_post (self, client: AsyncClient):
        """
    ...
    @pytest.mark.asyncio
    async def test_auth_login_post (self, client: AsyncClient, test_user: dict):
        """
    ...
    @pytest.mark.asyncio
    async def test_auth_logout_post (self, client: AsyncClient, test_user: dict):
        """
    ...
    @pytest.mark.asyncio
    async def test_auth_refresh_put (self, client: AsyncClient, test_user: dict):
        """
    ...
    @pytest.mark.asyncio
    async def test_auth_me_get (self, client: AsyncClient, auth_token: str):
        """
    ...
    @pytest.mark.asyncio
    async def test_auth_forgot_password_post (self, client: AsyncClient, test_user: dict):
        """
    ...
    async def test_auth_reset_password_post (
        ...
        response = await client.post (
            f"/api/auth/reset-password/{test_user['email']}?signed={token}",
            json={
    ...
    async def test_auth_verify_email_post (
        ...
        response = await client.post (
            f"/api/auth/verify-email/{test_user['email']}?signed={token}",
            headers={"Authorization": f"Bearer {auth_token}"}
        )
...
class TestUserAdmin:
    ...
    @pytest.mark.asyncio
    async def test_admin_users_index_get (self, client: AsyncClient, auth_token: str):
        """
    ...
    @pytest.mark.asyncio
    async def test_admin_users_store_post (self, client: AsyncClient, auth_token: str):
        """
